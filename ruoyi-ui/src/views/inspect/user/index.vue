<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list" border stripe>
      ...
      <el-table-column label="当前网格" width="150">
      ...
      <el-table-column label="操作" width="250">
        <template slot-scope="s">
          <el-select v-model="s.row._newCourtyardId" size="mini" placeholder="选择网格" style="width:130px" clearable>
...
export default {
  ...
  methods: {
    ...
    assign(row) {
      if (row._newCourtyardId === undefined) { this.$message.warning('请选择网格'); return; }
