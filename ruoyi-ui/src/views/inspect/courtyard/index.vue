<template>
  <div class="app-container">
    <el-form :inline="true" size="small">
      <el-form-item><el-button type="success" @click="openAdd" icon="el-icon-plus">新增院落</el-button></el-form-item>
    </el-form>

    <el-table v-loading="loading" :data="list" border stripe>
      <el-table-column label="排序" prop="sortOrder" width="80"/>
      <el-table-column label="院落名称" prop="courtyardName" min-width="180"/>
    ...
    <el-dialog :title="isEdit?'修改院落':'新增院落'" :visible.sync="dialogVisible" width="400px">
      <el-form :model="form" label-width="80px" size="small">
        <el-form-item label="院落名称"><el-input v-model="form.courtyardName"/></el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm('确定删除该院落?', '提示', { type: 'warning' }).then(() => {
